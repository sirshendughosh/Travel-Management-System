...
public class BookPackage extends JFrame implements ActionListener{
    ...
    BookPackage(String username){
       ...
       add(cpackage);
        ...
        URL loc = ClassLoader.getSystemResource("icons/bookpackage.jpg");
        if (loc == null){
            System.err.println("Image not found");
            return;
        }
        ImageIcon imageIcon = new ImageIcon(loc);
        Image i4 = imageIcon.getImage().getScaledInstance(500,300,Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == checkprice){
            ...
            try{
              ...
              JOptionPane.showMessageDialog(null, "Package Bookes Successfully");
              setVisible(false);
            }catch(Exception e){
                e.printStackTrace();
            }
